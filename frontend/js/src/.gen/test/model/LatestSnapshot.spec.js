...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiTitle.LatestSnapshot();
  });
  ...
  describe('LatestSnapshot', function() {
    it('should create an instance of LatestSnapshot', function() {
      // uncomment below and update the code to test LatestSnapshot
      //var instance = new ApiTitle.LatestSnapshot();
      //expect(instance).to.be.a(ApiTitle.LatestSnapshot);
    });
